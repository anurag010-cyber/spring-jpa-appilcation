package com.skipertech.springbootjap.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleCloudVendorException(CloudVendorNotFoundException cloudVendorNotFoundException) {
